...
class Settings:
    def __init__(self):
        ...
        # host_dir = '/content/drive/My Drive/SR_ADV/2022_2_24_2'
        ...
        self.image_dir_proc = f'{host_dir}/proc' # save temp image dir
        self.weight_dir_save =  f'{host_dir}/weight' # save weight dir
        self.log_dir = f'{host_dir}/logs' # save logs dir
