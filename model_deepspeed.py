...
class MODEL():
    def __init__(self, opt):
        ...
        self.optimizer_D = optim.Adam(
            ...
            lr=opt.lr,
            betas=(opt.b1, opt.b2))
        self.model_engineG, self.optimizer_G, _, _ = deepspeed.initialize(
            args=opt,
            model=self.generator,
            model_parameters=self.generator.parameters(),
            optimizer=self.optimizer_G)
        self.model_engineD, self.optimizer_D, _, _ = deepspeed.initialize(
            args=opt,
    ...
    def pre_train(self, imgs, batches_done, epoch, batch_num):
        ...
        self.model_engineG.backward(loss_pixel)
        self.model_engineG.step()
    ...
    def train(self, imgs, batches_done, epoch, batch_num, opt):
        ...
        # loss_G.backward()
        # self.optimizer_G.step()
        self.model_engineG.backward(loss_G)
        self.model_engineG.step()

        # self.optimizer_D.zero_grad()
        self.model_engineD.zero_grad()
        ...
        self.model_engineD.backward(loss_D)
        self.model_engineD.step()
